...
// HTTP behaviour is covered in govtrack_test.go.
...
func TestHostWiring(t *testing.T) {
	...
	if want := "govtrack://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("govtrack", "about")
	if err != nil || got.String() != "govtrack://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want govtrack://page/about", got.String(), err)
	}
}
